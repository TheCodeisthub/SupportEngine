  ...
  <Layout>
    ...
    <section className="container">
      <div className="t__container">
        <h2>Support Engine Terms of Service</h2>
        ...
        <section>
          ...
          <ol type="a">
            <li>
              ...
              materials (information or software) on Support Engine's website
              ...
              <ol type="i">
                ...
                <li>
                  ...
                  contained on Support Engine's website;
                </li>
                <li>
            ...
            <li>
              ...
              these restrictions and may be terminated by Support Engine at any
        ...
        <section>
          ...
          <ol type="a">
            <li>
              The materials on Support Engine's website are provided on an 'as
              is' basis. Support Engine makes no warranties, expressed or
            ...
            <li>
              Further, Support Engine does not warrant or make any
        ...
        <section>
          <h3>4. Limitations</h3>
          <p>
            In no event shall Support Engine or its suppliers be liable for any
            damages (including, without limitation, damages for loss of data or
            profit, or due to business interruption) arising out of the use or
            inability to use the materials on Support Engine's website, even if
            Support Engine or a Support Engine authorized representative has
        ...
        <section>
          ...
          <p>
            The materials appearing on Support Engine's website could include
            technical, typographical, or photographic errors. Support Engine
            does not warrant that any of the materials on its website are
            accurate, complete or current. Support Engine may make changes to
            the materials contained on its website at any time without notice.
            However Support Engine does not make any commitment to update the
            materials.
          </p>
        </section>
        ...
        <section>
          <h3>6. Links</h3>
          <p>
            Support Engine has not reviewed all of the sites linked to its
            website and is not responsible for the contents of any such linked
            site. The inclusion of any link does not imply endorsement by
            Support Engine of the site. Use of any such linked website is at the
            user's own risk.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Support Engine may revise these terms of service for its website at
